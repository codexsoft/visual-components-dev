...
export default class Tools {
    ...
    public static blobToFile( blob: Blob, contentType: string, filename: string = 'file' ): File {
    ...
    public static getFileBasename( path: string ): string {
     ...
     * @returns {string}
     */
    public static getFilenameWithExt(filepath: string): string {
     ...
     */
    public static fireEvent(element: HTMLElement, event: string) {
        let evt;
    ...
    public static setSelectionRange(input: HTMLInputElement, selectionStart: number, selectionEnd: number) {
    ...
    public static setCaretToPos(input: HTMLInputElement, pos: number): void {
     ...
     * @throws {Error}
     */
    public static swapNodes(elm1: Node, elm2: Node) {
        let parent1, next1,
            parent2, next2;
